...
<h1 align="center">Green Sails</h1>
...
- The name "Green Sails" is also copyright protected and should be changed to the name of your market.
...
Green Sails also includes a number of advanced features that are suitable for an enterprise data market, such as:
...
Green Sails comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
